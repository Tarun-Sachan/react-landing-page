    ...
    <div className="w-full py-[10rem] px-4 bg-white">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-bold">Rs.15000</p>
        ...
        <div className="w-full bg-gray-100 shadow-xl flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-bold">Rs.25000</p>
          <div className="text-center font-medium">
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-bold">Rs.30000</p>
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">4000 GB Storage</p>
